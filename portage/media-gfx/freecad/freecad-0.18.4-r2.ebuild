...
IUSE="debug doc mpi netgen pcl bg-dark"
...
PATCHES=(
	...
	"${FILESDIR}/${P}_0007_remove_unconditional_ccache.patch"
	"${FILESDIR}/${P}_0008_pybind_ugly-build-fix.patch"
	"${FILESDIR}/${P}_0009_optional_dark_background_capability.patch"
)
